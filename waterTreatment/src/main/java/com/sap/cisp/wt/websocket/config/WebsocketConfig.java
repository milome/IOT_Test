...
public class WebsocketConfig {
     ...
     */
    public WebsocketConfig(String username, String apiKey) {
        this();
     ...
     */
    public WebsocketConfig auth(String username, String apiKey) {
     ...
     * @return this
     */
    public WebsocketConfig proxy(String host, int port) {
     ...
     * @return this
     */
    public WebsocketConfig proxy(String host, int port, String username, String password) {
    ...
    public WebsocketConfig host(String host) {
        this.host = host;
        return this;
    }
     ...
     * @return this
     */
    public WebsocketConfig urlEncodingFormat(String format) {
